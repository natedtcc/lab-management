...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($username && $password) {
		...
		$customer_query = "SELECT * FROM admins WHERE (username='$username' AND pass=SHA1('$password'))";		
		$result = mysqli_query ($db_conn, $customer_query) or trigger_error("Query: $customer_query\n<br />MySQL Error: " . mysqli_error($db_conn));
...
<center><p class="blockquote"><small>Your browser must allow cookies in order to log in.</small></p>
<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
	<fieldset><center>
	<p><b>Username:</b><br><input type="text" required="required" name="username" style="width: 150px;" maxlength="15" /></p>
	<p><b>Password:</b><br><input type="password" required="required" name="password" style="width: 100px;" maxlength="20" /></p>
	<div align="center"><input type="submit" class="btn-dark" style="width: 75px; name="submit" value="Login" /></div>
	</fieldset>
</form>
<br>
<button id="view_servers" class="btn-dark" style="width: 75px;" onclick="document.location.href='home.php'" padding="10">Back</button>
</div>
